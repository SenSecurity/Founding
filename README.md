...
## Description
The Founding is a tool that receives a Shellcode in ```bash.bin``` format, Obfuscates or Encrypts this shellcode and then generates a new binary utilizing some execution techniques.
